...
const Dashboard: React.FC = () => {
  ...
  useEffect(() => {
    async function loadTransactions(): Promise<void> {
      ...
      const { balance, transactions: Transactions } = data;
      ...
      const modelTransaction: Transaction[] = Transactions.map(
      ...
      setTransactions(modelTransaction);
    }
              ...
              {transactions.map((item, i) => {
                return (
                  <tr key={item.id}>
                    ...
                    {item.type == 'income' ? (
                      <td className="income"> {item.formattedValue}</td>
                    ) : (
                      <td className="outcome">- {item.formattedValue}</td>
                    )}
